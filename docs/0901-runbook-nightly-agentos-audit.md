# 0901 - Runbook: Nightly AgentOS Audit

## Purpose

Comprehensive self-audit of the AgentOS documentation system using extended thinking (ultrathink) for deep analysis. This runbook describes how to invoke the audit and what to expect.
...
```
Run the AgentOS Audit (0807) with extended analysis. Use ultrathink for deep conflict detection and redundancy analysis. After findings, offer to batch-create GitHub issues.
```
