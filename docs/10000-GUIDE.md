...
| Security / WAF / Auth | `AgentOS:audits/0801-security-audit` |
| Privacy / Data Storage | `AgentOS:audits/0802-privacy-audit` |
| Performance / Latency | `0812-audit-performance.md` |
| Code Quality / Linting | `AgentOS:audits/0803-code-quality-audit` |
...
* **`08xx` (Audits):** Verification and compliance procedures.
    ...
    * `AgentOS:audits/0803-code-quality-audit` — SOLID, complexity, coverage metrics.
    * `AgentOS:audits/0805-license-compliance` — SPDX license compatibility.
    * `AgentOS:audits/0806-claude-capabilities` — Weekly Claude Code feature tracking.
