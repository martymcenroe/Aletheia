...
Update Reason: Fixed mechanical validation errors - corrected directory paths to match actual repository structure
-->
...
|----|----------|------|-------|-----------------|---------------|
| 010 | ADR 10217 structure | Auto | `docs/adrs/10217-jwt-authentication.md` | Valid markdown with all sections | grep finds Status, Context, Decision, Consequences |
| 020 | ADR 10218 structure | Auto | `docs/adrs/10218-daily-token-cap.md` | Valid markdown with all sections | grep finds Status, Context, Decision, Consequences |
| 030 | ADR 10219 structure | Auto | `docs/adrs/10219-auth-middleware-pattern.md` | Valid markdown with all sections | grep finds Status, Context, Decision, Consequences |
| 040 | ADR index completeness | Auto | `docs/adrs/10200-index.md` | Contains all three new ADR entries | grep finds 10217, 10218, 10219 |
| 050 | Lessons learned content | Auto | `docs/lineage/active/370-lld/2026-02-pre-launch-lessons.md` | At least 6 categorized items | Line count of list items ≥ 6 |
| 060 | Blog draft structure | Auto | dispatch repo draft | Title, intro, sections present | grep finds # heading and ## subheadings |
| 070 | Markdown lint pass | Auto | All new .md files | No lint errors | `markdownlint` exit 0 |
...
markdownlint docs/adrs/10217-jwt-authentication.md docs/adrs/10218-daily-token-cap.md docs/adrs/10219-auth-middleware-pattern.md
```
