...
Updated By: Issue #341 LLD revision
...
| T140 | test_validate_jwt_dual_secret | Falls back to secondary secret | RED |
...
| 140 | JWT dual secret validation | Auto | JWT signed with old secret | AuthResult(success=True) | Falls back to secondary |
...
| Revision 1 | 2026-02-16 | PENDING | Fixed paths to use src/ directory structure |
